...
export function fasciaStipendio(costo) {
  ...
  if (costo <= 30) return 6;
  if (costo <= 40) return 7;
  if (costo <= 50) return 8;
  if (costo <= 60) return 9;
  if (costo <= 70) return 10;
  if (costo <= 80) return 11;
  if (costo <= 90) return 12;
  if (costo <= 100) return 13;
  if (costo <= 150) return 14;
  return 15;
}
