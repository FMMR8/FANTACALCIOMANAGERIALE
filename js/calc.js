...
// Impatto economico di un singolo prestito giocatore (stesso calcolo usato nel Conto Economico:
// il Costo riscatto conta solo se l'Obbligo è certo, mai con Secco/Diritto finché non lo eserciti davvero).
export function impattoPrestitoGiocatore(p) {
  ...
  return (p.costoPrestito || 0) + riscattoEffettivo + stipendioEffettivo;
}
