...
export const STADI = [
  { nome: "20 mila posti",  costo: 50,  sconfitta: 1.84,  pareggio: 2.50,  vittoria: 3.16,  investimento: null },
  { nome: "50 mila posti",  costo: 100, sconfitta: 4.74,  pareggio: 5.53,  vittoria: 6.32,  investimento: 100 },
  { nome: "80 mila posti",  costo: 150, sconfitta: 7.63,  pareggio: 8.55,  vittoria: 9.47,  investimento: 150 },
  { nome: "100 mila posti", costo: 200, sconfitta: 10.53, pareggio: 11.58, vittoria: 12.63, investimento: 200 },
];

export const PREMIO_CAMPIONATO = [100, 90, 82, 75, 72, 68, 63, 60]; // indice 0 = 1° posto
...
export function calcolaContoEconomico(stato) {
  ...
  // Bonus prima asta: solo nella primissima stagione, copre esattamente quanto speso all'asta iniziale,
  // così tutti partono da 0 invece che da un capitale di partenza figurato.
  const bonusPrimaAsta = stato.primaStagione
    ? (stato.acquistiAsta || []).reduce((s, a) => s + (a.costo || 0), 0)
    : 0;
