...
function renderRosa() {
  ...
  <div class="sezione">
    ...
    <p style="font-size:12px;color:var(--gesso-ombra)">Report — si modifica da Mercato. Sposta un giocatore tra Titolari/Under 21/Extra col menu a destra di ogni riga.</p>
...
function renderMercato() {
  ...
  <div class="sezione">
    ...
    <p style="font-size:12px;color:var(--gesso-ombra)">Se IN ENTRATA, non aggiungerlo in Rosa. Costo riscatto conta nel bilancio solo con Obbligo (certo); con Diritto è solo indicativo finché non lo eserciti davvero. Stipendio: negativo se lo paghi tu, positivo se risparmi.</p>
...
function renderIstruzioni() {
  ...
  ${sezioneIstr("👕 Rosa calciatori", `
    ...
    <b>Valore residuo</b> = costo pieno diviso gli anni di contratto (mai dimezzato, anche per gli U21) — conta quando vendi o svincoli.
    ${tabFasce}
  `)}
