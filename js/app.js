...
function renderStoricoStagioni() {
  ...
  <div class="sezione">
    ...
    <div class="tabella-scroll">
      <table class="tabella-rosa">
        <thead><tr><th>Anno</th><th>Variazione Capitale</th><th>Capitale Provv.</th><th>Campionato</th><th>Coppa</th><th>Champions</th><th>Stadio</th></tr></thead>
        <tbody>${righe}</tbody>
      </table>
    </div>
  </div>`;
...
function renderIstruzioni() {
  ...
  ${sezioneIstr("💰 Conto Economico", `
    ...
    Il <b>Capitale Provvisorio</b> è la cassa vera — conta la spesa reale all'asta, non l'ammortamento — e resta sempre visibile nei riquadri in cima alla pagina, insieme alla <b>Variazione Capitale</b> (quanto è salito o sceso rispetto al Capitale Iniziale di questa stagione).<br>
    Se finisci la stagione con il Capitale Provvisorio <b>negativo</b>, scattano sanzioni la stagione successiva (da applicare a mano — il sito non lo fa da solo):
    ${tabSanzioni}
  `)}
  ...
  ${sezioneIstr("🔄 Chiudere la stagione", `
    ...
    Subito sotto al pulsante resta per sempre un <b>Registro bilanci passati</b>: una copia non modificabile con anno, Variazione Capitale, Capitale Provvisorio e piazzamenti di ogni stagione già chiusa — così anche dopo che tutto si azzera, la storia della squadra resta consultabile.
  `)}
  `;
}
