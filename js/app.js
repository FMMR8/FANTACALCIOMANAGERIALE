...
function renderIstruzioni() {
  ...
  ${sezioneIstr("🔄 Chiudere la stagione", `
    ...
    Subito sotto al pulsante resta per sempre un <b>Registro bilanci passati</b>: una copia non modificabile con anno, Variazione Capitale, Capitale Provvisorio Prossima Stagione e piazzamenti di ogni stagione già chiusa — così anche dopo che tutto si azzera, la storia della squadra resta consultabile.
  `)}
  `;
}
