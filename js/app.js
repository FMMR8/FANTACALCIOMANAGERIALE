...
async function renderAltreSquadre() {
  ...
  const tabellaTitolo = (titolo, icona, chiave) => {
    ...
    <div class="sezione">
      <h3>${icona} ${titolo}</h3>
      <div class="tabella-scroll"><table class="tabella-rosa">
        <thead><tr><th>#</th><th>Squadra</th><th>Vinti</th></tr></thead>
        <tbody>${righe}</tbody>
      </table></div>
    </div>`;
  };
  ...
  // ===== Classifica sportiva dell'ultima stagione conclusa =====
  ...
  const righeSportiva = sportiva.map(({ nome, nickname, r }) => `
    <tr${rigaMia(nickname)}>
      <td>${r.piazzamentoCampionato ? r.piazzamentoCampionato + "°" : "—"}</td>
      <td>${nome}${mioTag(nickname)}</td>
      <td>${r.risultatoChampions || "—"}</td>
      <td>${r.piazzamentoCoppa ? r.piazzamentoCoppa + "°" : "—"}</td>
    </tr>`).join("");
  ...
  const bloccoTitoli = `
    ...
    <div class="sezione">
      <h3>Classifica ${formattaStagione(annoUltimo)}</h3>
      <p style="font-size:12px;color:var(--testo-soft)">Come è finita l'ultima stagione conclusa.${notaMancanti}</p>
      <div class="tabella-scroll"><table class="tabella-rosa">
        <thead><tr><th>Pos.</th><th>Squadra</th><th>Champions</th><th>Coppa</th></tr></thead>
        <tbody>${righeSportiva}</tbody>
      </table></div>
    </div>`;
  ...
  const bloccoFinanze = `
    <div class="sezione">
      ...
      <div class="tabella-scroll"><table class="tabella-rosa">
        <thead><tr><th>#</th><th>Squadra</th><th>Capitale finale</th><th>Variazione</th></tr></thead>
    ...
    <div class="sezione">
      ...
      <div class="tabella-scroll"><table class="tabella-rosa">
        <thead><tr><th>#</th><th>Squadra</th><th>Variazione</th></tr></thead>
    ...
    <div class="sezione">
      ...
      <div class="tabella-scroll"><table class="tabella-rosa">
        <thead><tr><th>#</th><th>Giocatore</th><th>Costo</th><th>Squadra</th><th>Stagione</th></tr></thead>
    ...
    <div class="sezione">
      ...
      <div class="tabella-scroll"><table class="tabella-rosa">
        <thead><tr><th>#</th><th>Giocatore</th><th>Costo</th><th>A</th><th>Da</th><th>Stagione</th></tr></thead>
