...
function renderMercato() {
  ...
  <div class="sezione">
    ...
    <p style="font-size:12px;color:var(--gesso-ombra)">Se IN ENTRATA, non aggiungerlo in Rosa. Costo riscatto solo se Diritto/Obbligo. Stipendio: negativo se lo paghi tu, positivo se risparmi.</p>
...
function renderIstruzioni() {
  ...
  ${sezioneIstr("🔁 Mercato — Acquisti, Cessioni, Svincoli, Rinnovi, Prestiti giocatori", `
    ...
    <b>Prestiti giocatori tra squadre</b>: diverso dagli altri — se lo prendi IN ENTRATA non aggiungerlo in Rosa con un costo vero (o mettilo a 0), il vero impatto lo scrivi qui. Per un prestito Secco basta "Costo prestito"; con Diritto/Obbligo di riscatto compili anche "Costo riscatto" (0 se gratis). "Stipendio annuo" è il vero stipendio del giocatore (o la parte concordata): <b>negativo</b> se lo paghi tu (di solito IN ENTRATA), <b>positivo</b> se lo paga l'altra squadra ed è un risparmio per te (di solito IN USCITA) — con "Quota %" a 100/50/0 in base a quanta stagione copre. Se a fine anno il riscatto/obbligo si esercita davvero, il giocatore resta tuo per sempre — registra un Acquisto con costo = costo riscatto e togli la riga da qui; con un prestito Secco invece torna al proprietario da solo.<br>
