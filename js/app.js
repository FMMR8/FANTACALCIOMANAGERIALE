...
function renderIstruzioni() {
  ...
  const tabFasce = `<div class="tabella-scroll"><table class="istr-tabella"><tr><th>Fascia di costo (mln)</th><th>Stipendio (mln)</th></tr>
    ...
    <tr><td>151-oltre</td><td>15</td></tr></table></div>`;
  ...
  ${sezioneIstr("📋 Anagrafica", `
    ...
    <b>Capitale iniziale</b> è quanto avevi a inizio stagione (500 il primo anno, poi lo aggiorna da solo "Termina Stagione", sola lettura). <b>Capitale speso in asta</b> si calcola da solo sommando gli Acquisti in asta in Mercato.
  `)}
