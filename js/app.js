  ...
  <div class="sezione">
    ...
    <div class="griglia-2">
      ...
      <div class="campo">
        ...
        <p style="font-family:var(--font-cifre);font-size:18px;color:var(--ambra);margin:8px 0 0">${(stato.capitaleIniziale || 0).toFixed(1)}</p>
        <p style="font-size:11px;color:var(--gesso-ombra);margin:2px 0 0">500 all'inizio per tutti — dalla seconda stagione si aggiorna da solo con "Chiudi stagione".</p>
      </div>
      <div class="campo">
