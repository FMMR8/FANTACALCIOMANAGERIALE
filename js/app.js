...
function renderBilancio() {
  ...
  <div class="sezione">
    <h3>Chiusura Bilancio</h3>
    <p style="font-size:13px;line-height:1.9">
      <span style="font-size:15px">CHIUSURA BILANCIO:</span> <b class="cifra" style="font-family:var(--font-cifre);font-size:22px;color:var(--oro-chiaro)">${ce.chiusura.toFixed(1)}</b>
    </p>
  </div>
  <div class="sezione" style="border:1px solid var(--rosso-cartellino)">
    <h3 style="color:var(--oro-chiaro)">Chiusura stagione ${formattaStagione(stato.stagioneCorrente)}</h3>
