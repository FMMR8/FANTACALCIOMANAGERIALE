...
function renderBilancio() {
  ...
  <div class="sezione">
    ...
    <p style="font-size:13px;line-height:1.9">
      ...
      Plusvalenze: <b class="cifra">${ce.plusvalenze.toFixed(1)}</b> · Minusvalenze: <b class="cifra">${ce.minusvalenze.toFixed(1)}</b>
    </p>
    <p style="font-size:15px;margin-top:6px">CHIUSURA BILANCIO<br>
      <span class="cifra" style="font-family:var(--font-cifre);font-size:22px;color:var(--ambra)">${ce.chiusura.toFixed(1)}</span>
    </p>
  </div>
  <div class="sezione" style="border:1px solid var(--rosso-cartellino)">
    <h3 style="color:#F4D935">Chiusura stagione ${formattaStagione(stato.stagioneCorrente)}</h3>
    <p style="font-size:13px;color:var(--gesso-ombra);line-height:1.7">
      Passa alla stagione ${formattaStagione(stato.stagioneCorrente + 1)}. Capitale iniziale nuovo:<br>
      <span class="cifra" style="font-family:var(--font-cifre);font-size:22px;color:var(--ambra)">${ce.capitaleProvvisorio.toFixed(1)}</span><br>
