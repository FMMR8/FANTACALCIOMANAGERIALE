...
async function renderAltreSquadre() {
  ...
  const bloccoTitoli = `
    ...
    <div class="sezione">
      ...
      <div class="campo" style="margin-bottom:14px">
        ...
        <select id="albo-anno">${opzioniAnni}</select>
      </div>
      <p style="font-size:13px;font-weight:600;color:var(--oro-chiaro);margin:16px 0 6px">🏆 Campionato</p>
      <div class="tabella-scroll"><table class="tabella-rosa">
        <thead><tr><th>Pos.</th><th>Squadra</th></tr></thead>
        <tbody>${classCampionato}</tbody>
      </table></div>
      <p style="font-size:13px;font-weight:600;color:var(--oro-chiaro);margin:20px 0 6px">⭐ Champions</p>
      <div class="tabella-scroll"><table class="tabella-rosa">
        <thead><tr><th>Fase</th><th>Squadra</th></tr></thead>
        <tbody>${classChampions}</tbody>
      </table></div>
      <p style="font-size:13px;font-weight:600;color:var(--oro-chiaro);margin:20px 0 6px">🥇 Coppa</p>
      <div class="tabella-scroll"><table class="tabella-rosa">
        <thead><tr><th>Pos.</th><th>Squadra</th></tr></thead>
  ...
  const bloccoFinanze = `
    <div class="sezione">
      <h3>Classifica finanziaria ${formattaStagione(annoUltimo)}</h3>
      <p style="font-size:12px;color:var(--testo-soft)">Capitale a fine stagione, dal più ricco al più povero.</p>
      <div class="tabella-scroll"><table class="tabella-rosa">
        <thead><tr><th>#</th><th>Squadra</th><th class="cifra-h">Capitale finale</th><th class="cifra-h">Variazione</th></tr></thead>
        <tbody>${righeFinanziaria}</tbody>
      </table></div>
    </div>

    <div class="sezione">
      <h3>Miglior crescita ${formattaStagione(annoUltimo)}</h3>
  ...
  el.innerHTML = atabAttiva === "finanze" ? bloccoFinanze : bloccoTitoli;
  document.getElementById("albo-anno")?.addEventListener("change", (e) => {
    annoScelto = parseInt(e.target.value);
    renderAltreSquadre();
  });
}
