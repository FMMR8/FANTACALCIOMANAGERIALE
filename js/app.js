...
function renderAvvisoSanzione(capitale) {
  ...
  <div class="sezione" style="border-color:var(--rosso-cartellino); background:rgba(193,39,45,0.10)">
    ...
    <p style="font-size:13px;color:var(--testo-soft);margin:8px 0 0">
      ...
      <b style="color:var(--rosso-cartellino)">${sanzione.punti} punti</b> in classifica (fascia ${sanzione.da}–${sanzione.a === Infinity ? "in su" : sanzione.a}).
...
function renderIstruzioni() {
  ...
  ${sezioneIstr("📋 Anagrafica", `
    Nome società, Presidente e Allenatore servono solo a farti riconoscere dagli altri. <b>Stagione corrente</b> è l'anno di gioco: da questo il sito calcola quanti anni restano a ogni contratto — non toccarla a mano, si aggiorna da sola quando premi "Termina Stagione".<br><br>

    <b>Il budget del primo anno.</b> Parti con Capitale iniziale a 0, ma nel Conto Economico ti compare una voce "Bonus prima asta" da <b>500</b>: quello è il tuo budget d'asta. È uguale per tutti e vale solo la prima stagione, poi sparisce da solo. Se all'asta spendi meno di 500 la differenza ti resta in cassa; se spendi di più parti sotto zero.<br><br>

    <b>Capitale iniziale</b> (sola lettura) è quanto avevi in cassa a inizio stagione: dal secondo anno in poi lo riempie "Termina Stagione" con quello che ti era avanzato. <b>Capitale speso in asta</b> si somma da solo man mano che inserisci gli acquisti.<br><br>

    <b>Bacheca</b>: in fondo alla pagina, i trofei vinti dalla tua squadra (campionato, Champions, coppa). Parte da zero e si aggiorna da sola ogni volta che vinci qualcosa e chiudi la stagione.
  `)}
