...
function graficoLinee(serie, { altezza = 220, conLegenda = false } = {}) {
  ...
  const tacche = Array.from({ length: 5 }, (_, i) => minY + (i / 4) * (maxY - minY));
  ...
  const bloccoFinanze = `
    ...
    ${(() => {
      ...
      return `<div class="sezione">
        ...
        ${graficoLinee(serie, { altezza: 260, conLegenda: true })}
      </div>`;
    })()}
