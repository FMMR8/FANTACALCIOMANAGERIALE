...
async function renderRosaAltraSquadra(nickname, nomeVisualizzato) {
  ...
  const sezioni = gruppi.map(({ chiave, etichetta }) => {
    ...
    <div class="tabella-scroll"><table class="tabella-rosa" style="max-width:420px">
      <thead><tr><th style="width:50px">Ruolo</th><th>Nome</th><th style="text-align:right">Anni rimanenti</th></tr></thead>
