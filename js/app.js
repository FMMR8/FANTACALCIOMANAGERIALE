...
function renderRosa() {
  ...
  const u21Classe = totaleU21 <= 5 ? "riga-check-ok" : "riga-check-warn";
  const u21Testo = totaleU21 <= 5 ? `✅ Under 21: ${totaleU21}/5` : `⚠️ Under 21: ${totaleU21}/5 — massimo consentito superato`;
...
function renderIstruzioni() {
  ...
  ${sezioneIstr("👕 Rosa calciatori", `
    ...
    <b>Titolari</b>: servono esattamente 3 portieri, 8 difensori, 8 centrocampisti, 6 attaccanti (avviso sopra la tabella se non torna). <b>Under 21</b>: massimo 5 (avviso se superato) — <b>solo lo stipendio</b> dimezzato rispetto al normale (l'ammortamento resta uguale a tutti), e torna normale se lo sposti via da qui — pensato per i giocatori davvero U21, non un modo per risparmiare su chiunque. <b>Extra</b>: nessuno sconto, nessun limite di numero.<br><br>
