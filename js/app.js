...
function renderBilancio() {
  ...
  <div class="sezione">
    ...
    <p style="font-size:13px;line-height:1.9">
      ...
      <span style="font-size:15px">RISULTATO MERCATO:</span> <b class="cifra" style="font-family:var(--font-cifre);font-size:18px;color:var(--oro-chiaro)">${(ce.plusvalenze - ce.minusvalenze).toFixed(1)}</b>
    </p>
  </div>
  <div class="sezione">
