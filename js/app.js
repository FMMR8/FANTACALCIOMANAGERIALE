...
function renderIstruzioni() {
  ...
  ${sezioneIstr("📁 Come funziona il sito", `
    ...
    Una volta dentro la tua squadra, il sito ha 7 sezioni (le trovi come schede in alto): <b>Anagrafica</b>, <b>Stadio</b>, <b>Sponsor & Premi</b>, <b>Rosa</b>, <b>Gestione Rosa</b>, <b>Banca</b>, <b>Conto Economico</b> — più il pulsante <b>Termina Stagione</b> in fondo al Conto Economico. In alto trovi anche <b>🔄 Mercato</b> (le trattative con le altre squadre) e <b>👥 Altre squadre</b> (le rose altrui, solo in lettura). Chi entra come <b>ADMIN</b> vede invece una schermata separata con i bilanci di tutte le squadre della lega.<br>
  ...
  ${sezioneIstr("📋 Anagrafica", `
    Nome società e Allenatore sono solo per riconoscerti. <b>Stagione corrente</b> è l'anno di gioco: serve a calcolare da sola quanti anni restano ai contratti dei giocatori e il loro valore residuo — aggiornala solo premendo il pulsante "Termina Stagione", non a mano.
    <b>Capitale iniziale</b> è quanto avevi a inizio stagione (0 il primo anno — ma ricevi un <b>Bonus prima asta di 500</b> nei Ricavi, così parti con quel budget; poi lo aggiorna da solo "Termina Stagione", sola lettura). <b>Capitale speso in asta</b> si calcola da solo sommando gli Acquisti in asta in Mercato.
  `)}
  ...
  ${sezioneIstr("💰 Conto Economico", `
    ...
    Se finisci la stagione con il Capitale Provvisorio Prossima Stagione <b>negativo</b>, scattano sanzioni la stagione successiva (da applicare a mano — il sito non lo fa da solo):
    ${tabSanzioni}
  `)}
